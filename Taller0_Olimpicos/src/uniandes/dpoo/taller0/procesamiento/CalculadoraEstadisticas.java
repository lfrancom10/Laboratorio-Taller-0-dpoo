...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta el nombre de un atleta y retorna su nacionalidad
	 */
	...
	public String NacionalidadporAtletas(String nombreAtleta)
	{
		
		Atleta elNombre = buscarAtleta(nombreAtleta);
		Pais elpais = elNombre.darPais();
		String name = elpais.darNombre();
		return name;
	}
