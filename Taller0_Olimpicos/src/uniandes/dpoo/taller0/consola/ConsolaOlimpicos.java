...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar nacionalidad dado el nombre");
	...
	/**
	 * Ejecuta la opción para consultar la nacionalidad de un atleta.
	 */
	private void ejecutarConsultarNacionalidad()
	{
		
		String atleta = input("Ingrese el nombre del atleta: ");
		String atletas = calculadora.NacionalidadporAtletas(atleta);
		System.out.println("La atleta "+atleta+" es de la nacionalidad: "+atletas);
	}
